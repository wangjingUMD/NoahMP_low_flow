...
date = "20200101" # Manually set the date
...
#results_dir = "/21dayscratch/scr/s/d/sdjwang1/Data_Repository/extracted_GLDAS_data/INIT"
data_dir = "./GLDAS_path"
results_dir = "./extract_GLDAS_US/INIT"
