...
def extract_gldas_JW(vars_name_JW,vars_short_JW):
    ...
    vars_name = [vars_name_JW]
    vars_short = [vars_short_JW]

    #data_dir = "/glade/work/zhezhang/GLDAS/raw"
    #results_dir = "/glade/work/zhezhang/GLDAS/extracted"
    data_dir = "/21dayscratch/scr/s/d/sdjwang1/Data_Repository/GLDAS"
    results_dir = "/21dayscratch/scr/s/d/sdjwang1/Data_Repository/extracted_GLDAS_data_path_US"
